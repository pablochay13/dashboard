...
{
    public partial class timer_banner_bd_full : MetroFramework.Forms.MetroForm
    {
        MySqlConnection con = new MySqlConnection(variables.Sentencia);

        public timer_banner_bd_full()
        {
            InitializeComponent();
        ...
        private void timer_banner_bd_full_Load(object sender, EventArgs e)
        {
        ...
        private void filter_Click(object sender, EventArgs e)
        {
            ...
            if (cbFechas.Checked == true)
            {
                ...
                sentencia = "SELECT * FROM timer_banner_bd WHERE fecha BETWEEN'" + inicio + "'AND'" + fin + "'";
            }

            if (check_hotel.Checked == true)
            {
                busqueda = hotel_combo.Text;
                sentencia = "SELECT * FROM timer_banner_bd WHERE hotel LIKE '%" + busqueda + "%'";
            }
        ...
        public void llenar()
        {
            ...
            {
                con.Open();
                MySqlDataAdapter sda = new MySqlDataAdapter("SELECT * FROM timer_banner_bd", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                foreach (DataRow item in dt.Rows)
                {
